...
export const sampleGames: Game[] = [
  {
    ...
    gameImageURL: [
      "https://placeholder.svg?height=600&width=424&text=스타필드",
    ],
    gameBinaryName: "Starfield.exe",
    gameHeadline: {
      ko: "우주를 탐험하는 대규모 SF 롤플레잉 게임",
      en: "A large-scale sci-fi role-playing game exploring space",
    },
    gameDescription: {
  ...
  //   gameImageURL:
  //     "https://placeholder.svg?height=600&width=424&text=사이버펑크+2077",
  ...
  //   gameImageURL:
  //     "https://placeholder.svg?height=600&width=424&text=마인크래프트",
